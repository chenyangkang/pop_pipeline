...
${psmc_util_path}/splitfa ${output_mid_file_dict}/03.psmc/${species_or_pop_name}.merged.d${min_depth}.psmcfa > ${output_mid_file_dict}/03.psmc/${species_or_pop_name}.merged.d${min_depth}.split.psmcfa
